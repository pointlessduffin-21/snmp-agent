...
class MIBDefinitions:
    ...
    # HVAC table (.8)
    HVAC_TABLE = f"{HW_AGGREGATOR}.8"
    HVAC_ENTRY = f"{HVAC_TABLE}.1"
    HVAC_INDEX = f"{HVAC_ENTRY}.1"
    HVAC_SUPPLY_TEMP = f"{HVAC_ENTRY}.2"
    HVAC_RETURN_TEMP = f"{HVAC_ENTRY}.3"
    HVAC_SETPOINT_TEMP = f"{HVAC_ENTRY}.4"
    HVAC_SUPPLY_HUMIDITY = f"{HVAC_ENTRY}.5"
    HVAC_RETURN_HUMIDITY = f"{HVAC_ENTRY}.6"
    HVAC_SETPOINT_HUMIDITY = f"{HVAC_ENTRY}.7"
    HVAC_UNIT_STATUS = f"{HVAC_ENTRY}.8"
    HVAC_COOLING_CAPACITY = f"{HVAC_ENTRY}.9"
    HVAC_FAN_SPEED = f"{HVAC_ENTRY}.10"
    HVAC_AIRFLOW = f"{HVAC_ENTRY}.11"
    HVAC_POWER_WATTS = f"{HVAC_ENTRY}.12"
    HVAC_ALARM_COUNT = f"{HVAC_ENTRY}.13"
    HVAC_VENDOR_PROFILE = f"{HVAC_ENTRY}.14"
